...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\laragon\www\app-sistem-akademik\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\laragon\\www\\app-sistem-akademik\\public\\storage','logging.default','logging.deprecations.channel',
...
'mahasiswa.dashboard','mahasiswa.lihatJadwalKuliah','mahasiswa.lihatKHS','mahasiswa.lihatKRS','mahasiswa.lihatDataDosen',
'mahasiswa.lihatTagihanPembayaran','mahasiswa.lihatDetailPribadi','mahasiswa.showChangePasswordForm','mahasiswa.changePassword','dosen.dashboard',
'dosen.lihatJadwalMengajar','dosen.kelolaNilaiMahasiswa','dosen.lihatDaftarMahasiswa','admin.dashboard','admin.dosens.index',
'admin.dosens.create','admin.dosens.store','admin.dosens.show','admin.dosens.edit','admin.dosens.update',
'admin.dosens.destroy','admin.mataKuliahs.index','admin.mataKuliahs.create','admin.mataKuliahs.store','admin.mataKuliahs.show',
'admin.mataKuliahs.edit','admin.mataKuliahs.update','admin.mataKuliahs.destroy','admin.mahasiswas.index','admin.mahasiswas.create',
'admin.mahasiswas.store','admin.mahasiswas.show','admin.mahasiswas.edit','admin.mahasiswas.update','admin.mahasiswas.destroy',
'admin.jadwalKuliahs.index','admin.jadwalKuliahs.create','admin.jadwalKuliahs.store','admin.jadwalKuliahs.show','admin.jadwalKuliahs.edit',
'admin.jadwalKuliahs.update','admin.jadwalKuliahs.destroy','admin.pengampuMataKuliah.index','admin.pengampuMataKuliah.create','admin.pengampuMataKuliah.store',
'admin.pengampuMataKuliah.edit','admin.pengampuMataKuliah.update','admin.pengampuMataKuliah.destroy','admin.nilaiMahasiswas.index','admin.nilaiMahasiswas.create',
'admin.nilaiMahasiswas.store','admin.nilaiMahasiswas.edit','admin.nilaiMahasiswas.update','admin.nilaiMahasiswas.destroy','admin.tagihanPembayarans.index',
'admin.tagihanPembayarans.create','admin.tagihanPembayarans.store','admin.tagihanPembayarans.edit','admin.tagihanPembayarans.update','admin.tagihanPembayarans.destroy',
'register','password.request','password.email','password.reset',
'password.update','password.confirm','home','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.dosen.create','admin.dosen.edit','admin.dosen.index','admin.jadwal_kuliah.create',
'admin.jadwal_kuliah.edit','admin.jadwal_kuliah.index','admin.mahasiswa.create','admin.mahasiswa.edit','admin.mahasiswa.index',
'admin.mata_kuliah.create','admin.mata_kuliah.edit','admin.mata_kuliah.index','admin.nilai_mahasiswa.create','admin.nilai_mahasiswa.edit',
'admin.nilai_mahasiswa.index','admin.pengampu_mata_kuliah.create','admin.pengampu_mata_kuliah.edit','admin.pengampu_mata_kuliah.index','admin.tagihan_pembayaran.create',
'admin.tagihan_pembayaran.edit','admin.tagihan_pembayaran.index','auth.login','home','layouts.app',
'layouts.footer','layouts.navbar','layouts.sidebar-admin','layouts.sidebar-dosen','layouts.sidebar-mahasiswa',
'mahasiswa.change_password','mahasiswa.dashboard','mahasiswa.data_dosen','mahasiswa.detail_pribadi','mahasiswa.jadwal_kuliah',
'mahasiswa.khs','mahasiswa.krs','mahasiswa.tagihan_pembayaran','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
