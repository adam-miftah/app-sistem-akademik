...
@section('header_title', 'Edit Jadwal Kuliah')
    ...
    <div class="content-area">
        <div class="form-container">
            <div class="card-header">
                <h4 class="card-title">Form Edit Jadwal Kuliah</h4>
            </div>
            ...
            <form action="{{ route('admin.jadwalKuliahs.update', $jadwalKuliah->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <select id="hari" name="hari" class="form-control" required>
                        ...
                        @foreach ($haris as $hari)
                            <option value="{{ $hari }}" {{ old('hari', $jadwalKuliah->hari) == $hari ? 'selected' : '' }}>
                                {{ $hari }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="time" id="jam_mulai" name="jam_mulai" class="form-control"
                                value="{{ old('jam_mulai', \Carbon\Carbon::parse($jadwalKuliah->jam_mulai)->format('H:i')) }}"
                                required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="time" id="jam_selesai" name="jam_selesai" class="form-control"
                                value="{{ old('jam_selesai', \Carbon\Carbon::parse($jadwalKuliah->jam_selesai)->format('H:i')) }}"
                                required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="ruangan" name="ruangan" value="{{ old('ruangan', $jadwalKuliah->ruangan) }}"
                            class="form-control" placeholder="Contoh: A101, Lab Komputer 1" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <select id="kelas" name="kelas" class="form-control">
                            ...
                            @foreach ($kelasOptions as $option)
                                <option value="{{ $option }}" {{ old('kelas', $jadwalKuliah->kelas) == $option ? 'selected' : '' }}>
                                    {{ $option }}
                                </option>
                            @endforeach
                        </select>
