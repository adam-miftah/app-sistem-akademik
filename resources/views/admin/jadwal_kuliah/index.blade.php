...
@section('title', 'Kelola Jadwal Kuliah - Admin')
@section('header_title', 'Kelola Jadwal Kuliah')
...
@section('content')
  <style>
    ...
    /* Warna berbeda untuk hari tertentu */
  ...
  <div class="content-area">
    ...
    {{-- Form Filter --}}
    <form action="{{ route('admin.jadwalKuliahs.index') }}" method="GET" class="filter-form">
    ...
    <h3 class="page-title">Daftar Jadwal Kuliah</h3>
    <a href="{{ route('admin.jadwalKuliahs.create') }}" class="btn btn-primary">
      <i class="fas fa-plus"></i>
      <span class="btn-text">Tambah Jadwal</span>
    </a>
    </div>
    ...
    <table class="data-table">
      ...
      <td class="ruangan-badge">{{ $jadwal->ruangan }}</td>
      <td>{{ $jadwal->kelas ?? '-' }}</td>
      <td>
      <div class="action-buttons">
        <a href="{{ route('admin.jadwalKuliahs.edit', $jadwal->id) }}" class="btn btn-warning">
        <i class="fas fa-edit"></i>
        <span class="btn-text">Edit</span>
        </a>
        <form action="{{ route('admin.jadwalKuliahs.destroy', $jadwal->id) }}" method="POST"
