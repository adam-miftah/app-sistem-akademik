...
@section('title', 'Tambah Penugasan Dosen - Admin')
@section('header_title', 'Tambah Penugasan Dosen')
    ...
    <div class="content-area">
        <div class="form-container">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Penugasan Dosen</h4>
            </div>
            ...
            <form action="{{ route('admin.pengampuMataKuliah.store') }}" method="POST">
                @csrf
