...
@section('content')
    <div class="container-fluid">
        <h4 class="mb-4 fw-bold text-gradient"><i class="fas fa-edit me-2"></i>Edit Jadwal Mengajar</h4>
        <form action="{{ route('admin.pengampuMataKuliah.update', $pengampuMataKuliah->id) }}" method="POST" id="main-form">
            @csrf
            @method('PUT')
            @include('admin.pengampu_mata_kuliah.form', ['pengampuMataKuliah' => $pengampuMataKuliah])
        </form>
    </div>
@endsection
