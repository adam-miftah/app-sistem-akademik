...
@section('content')
  <div class="container-fluid">
    <h4 class="mb-4 fw-bold text-gradient"><i class="fas fa-plus-circle me-2"></i>Input Nilai Mahasiswa</h4>
    <form action="{{ route('admin.nilaiMahasiswas.store') }}" method="POST" id="main-form">
    @csrf
    @include('admin.nilai_mahasiswa.form', ['nilaiMahasiswa' => new App\Models\NilaiMahasiswa])
    </form>
  </div>
@endsection
